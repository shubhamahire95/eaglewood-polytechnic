...
-- â”€â”€ 1. Legacy admin sessions (migration 006) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ 2. verify_legacy_admin issues a write session token â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ 3. Link admins â†” auth.users (never touch generated columns) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
begin
  ...
  loop
    ...
    if email_confirmed_ts is null then
      -- confirmed_at is GENERATED â€” set email_confirmed_at only.
      update auth.users
...
-- â”€â”€ 4. Grants (idempotent) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ 5. Auth bootstrap (isolated â€” must not roll back migration 006) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ 6. Post-apply verification (read-only) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- Eaglewood CMS â€” one-click sync
-- Run this ONCE in Supabase SQL Editor to deploy bootstrap RPC and seed all CMS tables.

-- Bootstrap CMS default content (idempotent). Callable via RPC from homepage/admin.
...
begin
  ...
  select * from (values
    ('Eaglewood Polytechnic Institute', 'AICTE Approved â€¢ DTE 2634 â€¢ MSBTE 51307 â€” Learn, innovate and lead with practical engineering education in Majalgaon.', 'assets/images/uploaded/workshop-front.jpg', 'Apply for Admission', 'admission.html', 'Explore Courses', 'courses.html', true, 'published', 1, now(), now()),
  ...
  select * from (values
    ('Placement Highlights 2025', 'TCS', '85%', 'â‚¹6 LPA', 'â‚¹3.2 LPA', 120, 'assets/images/placement-interview.jpg', 'Placement training and mock interviews helped me secure a campus interview confidently.', 'Rahul K.', 'Computer Engineering', true, 'published', 1, now(), now()),
    ('Industry Partners', 'Infosys', '72%', 'â‚¹5.5 LPA', 'â‚¹3 LPA', 95, 'assets/images/placement-guidance.jpg', 'Industrial visits gave real context to our classroom learning.', 'Priya S.', 'Electrical Engineering', true, 'published', 2, now(), now()),
    ('Training & Placement Cell', 'Wipro', '80%', 'â‚¹6 LPA', 'â‚¹3.4 LPA', 110, 'assets/images/personality-development.jpg', 'Soft skills sessions improved my communication for interviews.', 'Amit D.', 'Civil Engineering', true, 'published', 3, now(), now())
  ...
  select * from (values
    ('footer_main', 'Main Footer', '{"tagline":"AICTE Approved â€¢ MSBTE Affiliated â€¢ DTE 2634","copyright":"Eaglewood Polytechnic Institute"}'::jsonb::jsonb, true, 'published', 1, now(), now()),
  ...
  insert into public.settings (key, value, published, status, display_order, created_at, updated_at) values
    ...
    ('achievements', '[{"title":"AICTE Approved Institute","description":"Recognised by AICTE and Government of Maharashtra for quality technical education.","icon":"ðŸ›","year":"2024"},{"title":"MSBTE Affiliation","description":"Affiliated to Maharashtra State Board of Technical Education with strong academic outcomes.","icon":"ðŸŽ“","year":"2024"},{"title":"Placement Excellence","description":"Consistent placement guidance and industry interaction for final-year students.","icon":"ðŸ’¼","year":"2025"},{"title":"Sports & Cultural Awards","description":"Students excel in zonal sports, annual gathering and technical events.","icon":"ðŸ…","year":"2025"},{"title":"Industrial Collaboration","description":"Regular industrial visits and expert lectures from industry professionals.","icon":"ðŸ­","year":"2025"},{"title":"Student Achievements","description":"Project exhibitions, poster presentations and technical competitions at state level.","icon":"â­","year":"2025"}]'::jsonb, true, 'active', 24, now(), now()),
    ('admission_steps', '[{"step":1,"title":"Check Eligibility","description":"Confirm diploma or degree pathway eligibility with the admission office.","icon":"ðŸ“‹"},{"step":2,"title":"Submit Application","description":"Fill the online form or visit campus with required documents.","icon":"ðŸ“"},{"step":3,"title":"Document Verification","description":"Original mark sheets, certificates and identity proofs are verified.","icon":"âœ…"},{"step":4,"title":"Seat Confirmation","description":"Complete admission formalities and fee payment as per guidelines.","icon":"ðŸŽ“"},{"step":5,"title":"Join Campus","description":"Attend induction, collect ID card and begin your engineering journey.","icon":"ðŸ«"}]'::jsonb, true, 'active', 25, now(), now()),
